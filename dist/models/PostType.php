...
abstract class PostType
{
     ...
     * @return array
     */
    public static function search(string $value, callable $callback = null): array
    {
        $models = static::query()->search($value)->find_all();
        return self::map($models, $callback);
    }
     ...
     * @return mixed|null
     */
    public function thumbnail(callable $callback, callable $defaultCallback = null)
    {
    ...
    public function relation(string $field, string $class, callable $callback = null): array
    {
        $ids = $this->acf($field);
